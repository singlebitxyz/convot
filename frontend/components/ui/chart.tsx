  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          "relative w-full text-xs [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-none [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-border [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-desc]:stroke-border [&_.recharts-reference-line-line]:stroke-border [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none",
          className
        )}
        {...props}
      >
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      return (
        <div className={cn("font-medium", labelClassName)} style={{ color }}>
          {value}
        </div>
      );
    }, [
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  (() => {
                    ...
                    return Array.isArray(formatted)
                      ? formatted.map(
                          (formattedItem: any, formattedIndex: number) => (
                            <React.Fragment key={formattedIndex}>
                              {formattedItem}
                            </React.Fragment>
                          )
                        )
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        ...
                        nestLabel ? "justify-between" : "justify-end"
                      )}
                    >
                      {nestLabel && (
                      ...
                      <span
                        ...
                        style={{
                          color: nestLabel ? indicatorColor : undefined,
                        }}
                      >
